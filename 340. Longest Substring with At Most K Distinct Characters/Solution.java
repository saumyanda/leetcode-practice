...
//shrink the window from the beginning if the count of distinct characters in the HashMap is larger than K
            while(counts.size()>k) //shrink the window till it gets to size k
            {
